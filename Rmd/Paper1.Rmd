...
* gjøre om referanser til APA7

# Introduction

The main purpose of this Rmd-script is to reproduce the results in paper 1. The whole process from reducing the raw data to doing the EFA and CFA are discussed. 

This R-markdown describes the analyses used to support the validity and reliability of the inferences based on the measure developed in the thesis. This includes exploratory factor analysis (EFA) and the confirmatory factor analysis (CFA) that was done to get the results in paper 1.
...
!NB Anonymisere raw data (blant annet studiested) før jeg legger det ut offentlig.
...
Ways to handle missing data is predictive mean matching when less than 10 % are missing, otherwise ML-methods (@weston_brief_2006; Flora et al., 2012; Watkins, 2018; @mcneish_challenging_2017; @gallagher_introduction_2013). 
