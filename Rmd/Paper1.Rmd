...
load(file="../data/processed_data/tpack-trelis_q_paper1_2023.Rdata")
```
...
```{r eval=T}
alpha(df_run2[,c("TK1", "TK2", "TK3")])
alpha(df_run2[,c("CK1", "PCK2", "PCK5", "CK5", "CK3", "CK2")])
alpha(df_run2[,c("TPK1","TPK4","TCK1","TCK4", "TPACK2","TPACK4")]) # , "TPK4"
```
...
```{r measureQ, eval=T}
measureQ(model_three_factor, CFA_TPACK_PST)
```
