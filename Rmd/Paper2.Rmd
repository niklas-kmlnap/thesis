...
This document presents the quantitative analyses done in paper 2. Descriptive and inferential analyses are done. The inferences are based on multiple regression analyses. 
...
The data is multilevel, as the PSTs (level 1) are grouped at the institutional level (level 2). 
...
Should I include interactions in the regression analysis?
