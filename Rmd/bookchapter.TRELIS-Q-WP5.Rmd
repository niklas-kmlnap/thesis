...
interaction.plot(x.factor = factor(data_clean$Trinn),
                 trace.factor = factor(data_clean$Gender),
...
m1 <- lm_robust(scale(TPACK, center=T, scale=T) ~ factor(Gender) * factor(Trinn) * factor(semester), 
...
m2 <- lm_robust(scale(TPACK) ~ factor(Gender) * factor(Trinn) * factor(semester) * factor(studiested), 
                clusters = factor(studiested), data=data_clean)
summary(m2)
```
...
```{r PCK}
# PCK
m3 <- lm_robust(TPACK ~ factor(Gender) * factor(Trinn) * factor(semester) * factor(studiested) + PCK, 
                clusters = factor(studiested), data=data_clean)
summary(m3)
...
```{r TK}
# TK
m4 <- lm_robust(TPACK ~ factor(Gender) * factor(Trinn) * factor(semester) * factor(studiested) + PCK + TK, 
                clusters = factor(studiested), data=data_clean)
summary(m4)
